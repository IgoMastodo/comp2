...
public class Fracao {
    ...
    private boolean positiva;  // indica o sinal da fração , por padrao positivo(true)
    ...
    private void atualizarFracaoIrredutivel() {
        ...
        this.fracaoIrredutivel = new Fracao(n, d, this.positiva); //lembrando que fracaoIrredutuvel é do tipo fracao , por isso o uso do construtor
    }
